...
CLASS_LOCATION_LIST_CACHE_KEY = "classlocation_list"
CLASS_LOCATION_LIST_CACHE_TTL = 3600

PUBLIC_HOLIDAY_LIST_CACHE_KEY = "publicholiday_list"
PUBLIC_HOLIDAY_LIST_CACHE_TTL = 3600
