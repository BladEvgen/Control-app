...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument('--subject_name', type=str, default='Test Subject', help='Subject name.')
        ...
        parser.add_argument('--date_at', type=str, default=timezone.now().date().isoformat(), help='Date of the attendance in YYYY-MM-DD format.')
    ...
    def handle(self, *args, **options):
        ...
        try:
            ...
            self.stdout.write(self.style.SUCCESS(f'Successfully created LessonAttendance with ID: {attendance.id}'))
